<template>
    <section>
        <Swiper
            ...
            :speed="1200"
        >
            <SwiperSlide v-for="obj, index in slide" :key="index" :virtualIndex="index" class="slider">
                <div class="w-full text-white py-11 flex items-center px-9 bg-center bg-cover bg-no-repeat" :class="obj.bg">
