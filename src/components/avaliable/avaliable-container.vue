  ...
  const avaliables:IAvaliableCard[] = [
    {
      ...
      avaliable: ["Produto excelente e a qualidade do serviço prestado ainda melhor. Tive todo suporte durante o período de pós compra/instalação. Recomendo muito a experiência com a elekro"],
      stars:5
    },
    {
      name: "Evelyn Werdine",
      avaliable:["Ótima qualidade e designer sofisticadp. A facilidade do app é um diferencial."],
      stars: 5
    },
    {
      name: "Rony Neri",
      avaliable: [
        ...
        "Recomendo muito para quem busca tecnologia e praticidade no dia a dia - e odeia ficar carregando chaves de casa de lado para o outro!"
      ],
      stars: 5
    },
    {
      name: "Scau Zhang",
      avaliable: [
        "Esta fechadura é incrível, perfeita para min e minha familia. Acabamos de nos mudar para o Brasil e a equipe da Elekro nos deu todo suporte que precisávamos para manter nosa casa tecnológica e segura. Todo o processo foi muito rápido, desde a compra"
      ],
      stars: 5
    },
    {
