...
<style scoped>
    ...
    .bg-image{
        @apply w-full h-screen max-h-[550px] lg:max-h-[692px] xl:max-h-[800px] bg-center bg-no-repeat relative mx-auto py-11 bg-[url('/assets/esticado.png')] bg-cover flex items-end lg:items-center justify-start mb-3
    }
    .container-text{
