<template>
   <Head>
        ...
        <meta name="google-site-verification" content="nZb4bRb9Z8nbCOp4HoeKzeTO821jsUmyTRb0lJfQgoI" />
    </Head>
    <main>
                ...
                <div class="my__container mx-auto lg:mr-0 sticky top-[7%]">
                    <div class="relative text-center mb-2 mt-[20px] lg:mb-0 lg:mt-0">
                      ...
                      <div class="flex gap-5 justify-center mt-0 lg:mt-24">
                          ...
                          <MyButtonTwo
                            href="https://www.elekrobrasil.com.br/produtos/fechadura-eletronica-digital-biometria-senha-campainha-wi-fi/"
