<template>
    <main>
        ...
        <Banner src="/images/structure.jpg" title="Elekro" text="Design e tecnologia, aliados à segurança"/>
        <section class="elekro-text">
            <div class="mx-auto container max-w-[1200px] px-5 md:px-3 relative z-20">
                <div class="text-base mb-6">
                    ...
                    <H2Title class="mb-5" data-aos="fade-up" data-aos-duration="1000">Valores</H2Title>
                    <div class="mb-9" data-aos="fade-up" data-aos-duration="1000">
                        <H3Title class="mb-1">Inovação</H3Title>
                    ...
                    <div class="mb-9" data-aos="fade-up" data-aos-duration="1000">
                        <H3Title class="mb-1">Qualidade</H3Title>
                    ...
                    <div class="mb-9" data-aos="fade-up" data-aos-duration="1000">
                        <H3Title class="mb-1">Respeito pelas pessoas</H3Title>
                    ...
                    <div class="mb-9" data-aos="fade-up" data-aos-duration="1000">
                        <H3Title class="mb-1">Transparência</H3Title>
                    ...
                    <div class="mb-9" data-aos="fade-up" data-aos-duration="1000">
                        <H2Title class="mb-5">Missão</H2Title>
                    ...
                    <div class="mb-9" data-aos="fade-up" data-aos-duration="1000">
                        <H2Title class="mb-5">Visão</H2Title>
